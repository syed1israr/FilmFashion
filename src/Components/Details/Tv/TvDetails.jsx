  ...
  return info ? (
    <div className='w-screen h-screen px-[10%] overflow-hidden overflow-y-auto' style={{
      ...
      backgroundRepeat:'no-repeat'
        ...
        <img src={`https://image.tmdb.org/t/p/original/${ info.detail.poster_path ||  info.detail.backdrop_path }`} className='  rounded-[5px] w-[40vh] object-cover shadow-[8px_16px_32px_2px_rgba(0,0,0.5)]' alt="" />
