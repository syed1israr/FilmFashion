...
const Header = ({ data }) => {
  ...
  return (
    ...
    >
     ...
     <p className='w-[70%] text-white mt-3  mb-3'>{data.overview.slice(0,200)}...<Link className=' text-blue-900 '>more </Link></p>
     <p className='text-white'>
        <i class="ri-megaphone-line text-yellow-500"></i> {data.release_date || "Coming Soon... "}
        <i class="ri-film-fill  text-yellow-500 ml-5" ></i>{data.media_type.toUpperCase()}
     </p>
