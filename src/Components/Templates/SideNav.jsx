...
const SideNav = () => {
  ...
  return (
    <div className="w-[18%] h-full  border-r-2 border-zinc-200 p-10 ">
      ...
      <Link  to= {'/trending'} className='hover:bg-[#3C887E]   p-5 text-white rounded-lg duration-300 flex items-center'> <RiBarChartBoxFill
          className="text-white  text-2xl ri-arrow-up-circle-fill mr-3"
        />trending</Link>
      <Link to={'/popular'} className='hover:bg-[#3C887E] p-5 text-white rounded-lg duration-300 flex items-center' ><RiStarHalfFill
          className="text-white  text-2xl ri-arrow-up-circle-fill mr-3"
        /> Popular </Link>
      <Link  to={'/movie'}  className='hover:bg-[#3C887E] p-5 text-white rounded-lg duration-300 flex items-center ' ><RiMovieLine
          className="text-white  text-2xl ri-arrow-up-circle-fill mr-3"
        />Movies</Link>
      <Link  to={'/tv'} className='hover:bg-[#3C887E] p-5 text-white rounded-lg duration-300 flex items-center'><RiTv2Line
          className="text-white  text-2xl ri-arrow-up-circle-fill mr-3"
        />TV Shows</Link>
      <Link to={'/person'}  className='hover:bg-[#3C887E] p-5 text-white rounded-lg duration-300 flex items-center'><RiTeamFill
          className="text-white  text-2xl ri-arrow-up-circle-fill mr-3"
        />people</Link>
      </nav>
