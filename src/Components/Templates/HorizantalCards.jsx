...
const  HorizantalCards=({data})=> {
  ...
  return (
        <div className='w-[100%]  h-[40vh]  flex overflow-y-hidden mb-5 pb-3'  >
            {
                data.map((data,i)=><div key={i} className=' ml-[20px] min-w-[20%] w-[50%]  bg-purple-900 rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 border border-pink-400'>
